...
""",
    ...
    def test_backend_parameter(self):
        ...
        self.assertIn("backend", invoke_subgraph_nodes[0].meta)
        self.assertEqual(invoke_subgraph_nodes[0].meta["backend"], backend)

        # Second invoke_subgraph (gn_without_backend) should have backend=None or no backend
        backend_value = invoke_subgraph_nodes[1].meta.get("backend", None)
